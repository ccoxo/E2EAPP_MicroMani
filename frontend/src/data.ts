...
export const defaultConfig: AppConfig = {
  ...
  teleop: {
    ...
    strategyVersion: 'e2e_omega7_native_v28_gripper_python_right_y_20260611',
    mappingMode: 'direct',
    swapHands: false,
    swapTeleopChannels: true,
    leftTranslationScale: 1.25,
    rightTranslationScale: 1.25,
    leftRotationScale: 1.2,
    rightRotationScale: 1.2,
    homeBeforeStart: true,
    leftAxisOutputScale: [0.65, 0.45, 0.45, 0.6, 0.16, 0.2],
    ...
    translationStartVelocityUmS: 1500,
    translationMaxVelocityUmS: 20000,
    rotationStartVelocityDegS: 2.5,
    rotationMaxVelocityDegS: 30,
