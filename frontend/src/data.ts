...
export const defaultConfig: AppConfig = {
  ...
  teleop: {
    ...
    strategyVersion: 'icf_omega7_qserialtest_v19_platform1_roll_yaw_direction_fix_20260515',
    swapHands: false,
    ...
    leftAxisOutputScale: [0.4, 0.2, 0.2, 1, 0.2, 0.2],
    rightAxisOutputScale: [0.4, 0.2, 0.2, 1, 0.2, 0.2],
