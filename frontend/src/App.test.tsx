...
describe('AppStation M0 frontend', () => {
  ...
  it('renders hardware-specific settings from the reference manual', () => {
    ...
    expect(defaultConfig.teleop.leftTranslationScale).toBe(1.25)
    expect(defaultConfig.teleop.rightTranslationScale).toBe(1.25)
    expect(defaultConfig.teleop.leftRotationScale).toBe(1.2)
    expect(defaultConfig.teleop.rightRotationScale).toBe(1.2)
    expect(defaultConfig.teleop.leftAxisOutputScale).toEqual([0.65, 0.45, 0.45, 0.6, 0.16, 0.2])
    expect(defaultConfig.teleop.rightAxisOutputScale).toEqual([0.65, 0.45, 0.45, 0.55, 0.16, 0.25])
    expect(defaultConfig.teleop.translationStartVelocityUmS).toBe(1500)
    expect(defaultConfig.teleop.translationMaxVelocityUmS).toBe(20000)
    expect(defaultConfig.teleop.rotationStartVelocityDegS).toBe(2.5)
    expect(defaultConfig.teleop.rotationMaxVelocityDegS).toBe(30)
    expect(defaultConfig.teleop.motionProfileAccSec).toBe(0.03)
    expect(defaultConfig.teleop.motionProfileDecSec).toBe(0.03)
    expect(defaultConfig.teleop.translationInputEpsilon).toBe(0.000005)
    expect(defaultConfig.teleop.rotationInputEpsilon).toBe(0.08)
